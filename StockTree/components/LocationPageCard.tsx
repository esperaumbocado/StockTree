...
const LocationPageCard = ({ name, description, items, subLocations, locationId }) => {
            ...
            >
                {name &&  items != null ? (
                  <>
                    ...
                    <Text style={[styles.partCount, { color: colorScheme === 'dark' ? '#ddd' : '#333' }]}>Parts: {items}</Text>
                    <Text style={[styles.partCount, { color: colorScheme === 'dark' ? '#ddd' : '#333' }]}>SubLocations: {subLocations}</Text>
                  </>
                ) : (
